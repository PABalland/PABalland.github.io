...
# read links 
setwd(paste0("/Users/pierre-alex/Dropbox/1-asg/1-production/3-projects/4-dutch-regions/2-analysis/tech"))
links = read.csv ("4-links-ext-full2018-2021-new.csv", sep = ",", header = T)
