...
for (dr in c("north", "east", "south", "west")) {
  ...
  tech.level = c("prio", "wipo", "4-digit","3-digit")
...
df2 = unique(df2[,  c("id", "x", "y", "value", "parent", "color", "count", "rca")])
...
i = tolower(i)
# save as d3plus 
setwd(paste0("/Users/pierre-alex/Dropbox/1-asg/1-production/3-projects/4-dutch-regions/3-outputs/deliverable-1/treemaps/", tl, "/", j, "/", dr, "-nl"))
